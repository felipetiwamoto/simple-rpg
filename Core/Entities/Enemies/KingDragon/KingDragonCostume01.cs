...
{
    internal class KingDragonCostume01 : Costume
    {
        public KingDragonCostume01(int copies)
        {
            Name = "KingDragonCostume01 Name";
            Description = "KingDragonCostume01 Description";
            Copies = copies;
            Cost = 3;
            Hits = 1;
            Range = new int[][]
