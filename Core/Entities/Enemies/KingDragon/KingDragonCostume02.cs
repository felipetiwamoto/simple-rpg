...
{
    internal class KingDragonCostume02 : Costume
    {
        public KingDragonCostume02(int copies)
        {
            Name = "KingDragonCostume02 Name";
            Description = "KingDragonCostume02 Description";
            Copies = copies;
            Cost = 4;
            Hits = 1;
            Range = new int[][]
