...
{
    internal class KingDragonCostume03 : Costume
    {
        public KingDragonCostume03(int copies)
        {
            Name = "KingDragonCostume03 Name";
            Description = "KingDragonCostume03 Description";
            Copies = copies;
            Cost = 5;
            Hits = 1;
            Range = new int[][]
