...
{
    internal class KingMutantCostume01 : Costume
    {
        public KingMutantCostume01(int copies)
        {
            Name = "KingMutantCostume01 Name";
            Description = "KingMutantCostume01 Description";
            Copies = copies;
            Cost = 3;
            Hits = 1;
            Range = new int[][]
