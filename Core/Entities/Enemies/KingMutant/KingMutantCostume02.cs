...
{
    internal class KingMutantCostume02 : Costume
    {
        public KingMutantCostume02(int copies)
        {
            Name = "KingMutantCostume02 Name";
            Description = "KingMutantCostume02 Description";
            Copies = copies;
            Cost = 4;
            Hits = 1;
            Range = new int[][]
