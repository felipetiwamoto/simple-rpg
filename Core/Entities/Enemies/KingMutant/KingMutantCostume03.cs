...
{
    internal class KingMutantCostume03 : Costume
    {
        public KingMutantCostume03(int copies)
        {
            Name = "KingMutantCostume03 Name";
            Description = "KingMutantCostume03 Description";
            Copies = copies;
            Cost = 5;
            Hits = 1;
            Range = new int[][]
