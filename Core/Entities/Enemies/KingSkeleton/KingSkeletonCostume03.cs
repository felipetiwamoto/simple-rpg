...
{
    internal class KingSkeletonCostume03 : Costume
    {
        public KingSkeletonCostume03(int copies)
        {
            Name = "KingSkeletonCostume03 Name";
            Description = "KingSkeletonCostume03 Description";
            Copies = copies;
            Cost = 5;
            Hits = 1;
            Range = new int[][]
